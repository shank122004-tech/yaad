...
const MockTestInterfaceModule = (function() {
  ...
  const injectMockTestUI = () => {
    ...
    style.textContent = `.mock-fullscreen-modal{position:fixed;top:0;left:0;right:0;bottom:0;background:linear-gradient(135deg, #1a1a2e 0%, #16213e 100%);z-index:9999;display:flex;flex-direction:column;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;color:#fff}.mock-header{display:flex;justify-content:space-between;align-items:center;padding:16px 24px;background:rgba(0,0,0,0.3);border-bottom:1px solid rgba(255,255,255,0.1);backdrop-filter:blur(10px)}.mock-header-left,.mock-header-right{display:flex;align-items:center;gap:24px}.mock-btn-back,.mock-btn-close{background:rgba(255,255,255,0.1);border:1px solid rgba(255,255,255,0.2);color:#fff;padding:8px 16px;border-radius:8px;cursor:pointer;font-size:14px;font-weight:600;transition:all 0.3s ease}.mock-btn-back:hover,.mock-btn-close:hover{background:rgba(255,255,255,0.2)}.mock-exam-info{display:flex;flex-direction:column;gap:4px}.mock-exam-name{font-size:18px;font-weight:700}.mock-exam-progress{font-size:12px;color:rgba(255,255,255,0.7)}.mock-timer{font-size:20px;font-weight:700;color:#ff6b6b;min-width:80px;text-align:right}.mock-container{flex:1;display:flex;flex-direction:column;overflow:hidden;padding:24px}.mock-question-section{flex:1;display:flex;align-items:center;justify-content:center;margin-bottom:24px;overflow-y:auto}.mock-question-card{background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:32px;max-width:800px;width:100%;backdrop-filter:blur(10px)}.mock-question-number{font-size:12px;color:rgba(255,255,255,0.6);text-transform:uppercase;letter-spacing:1px;font-weight:600;margin-bottom:12px}.mock-question-text{font-size:18px;font-weight:600;line-height:1.6;margin-bottom:28px}.mock-options{display:flex;flex-direction:column;gap:12px}.mock-option{display:flex;align-items:flex-start;gap:16px;padding:16px;background:rgba(255,255,255,0.05);border:2px solid rgba(255,255,255,0.1);border-radius:8px;cursor:pointer;transition:all 0.3s ease;text-align:left}.mock-option:hover{background:rgba(255,255,255,0.1);border-color:rgba(255,255,255,0.2);transform:translateX(4px)}.mock-option.selected{background:rgba(102,187,106,0.2);border-color:#66bb6a}.mock-option-letter{display:flex;align-items:center;justify-content:center;width:36px;height:36px;background:rgba(255,255,255,0.1);border-radius:6px;font-weight:700;flex-shrink:0}.mock-option.selected .mock-option-letter{background:#66bb6a}.mock-option-text{flex:1;color:rgba(255,255,255,0.9);font-size:15px;line-height:1.5}.mock-nav-section{display:flex;justify-content:space-between;align-items:center;gap:12px;padding:16px;background:rgba(255,255,255,0.05);border-radius:8px;border:1px solid rgba(255,255,255,0.1)}.mock-nav-btn{padding:10px 20px;background:rgba(255,255,255,0.1);border:1px solid rgba(255,255,255,0.2);color:#fff;border-radius:6px;cursor:pointer;font-weight:600;font-size:14px;transition:all 0.3s ease;white-space:nowrap}.mock-nav-btn:hover:not(:disabled){background:rgba(255,255,255,0.2)}.mock-nav-btn:disabled{opacity:0.5;cursor:not-allowed}.mock-nav-btn.mock-nav-submit{background:linear-gradient(135deg, #6366f1 0%, #4f46e5 100%);border-color:#4f46e5;flex:1;max-width:200px}.mock-nav-btn.mock-nav-submit:hover{background:linear-gradient(135deg, #4f46e5 0%, #4338ca 100%)}.mock-nav-counter{font-size:12px;color:rgba(255,255,255,0.6)}.mock-results-modal{position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.7);z-index:10000;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px);padding:20px}.mock-results-content{background:linear-gradient(135deg, #1a1a2e 0%, #16213e 100%);border-radius:16px;padding:32px;max-width:800px;width:100%;max-height:90vh;overflow-y:auto;position:relative}.mock-results-header{text-align:center;margin-bottom:32px}.mock-results-header h2{font-size:28px;font-weight:700;margin-bottom:8px}.mock-results-header p{color:rgba(255,255,255,0.6);font-size:16px}.mock-results-score{display:flex;gap:32px;margin-bottom:32px;padding:24px;background:rgba(255,255,255,0.05);border-radius:12px;border:1px solid rgba(255,255,255,0.1)}.mock-score-circle{display:flex;flex-direction:column;align-items:center;justify-content:center;width:140px;height:140px;background:conic-gradient(#66bb6a 0deg, #66bb6a 360deg);border-radius:50%;padding:3px;position:relative}.mock-score-circle::after{content:'';position:absolute;width:130px;height:130px;background:#1a1a2e;border-radius:50%;z-index:0}.mock-score-accuracy{font-size:36px;font-weight:700;color:#66bb6a;position:relative;z-index:1}.mock-score-label{font-size:12px;color:rgba(255,255,255,0.6);position:relative;z-index:1;margin-top:4px}.mock-results-stats{display:grid;grid-template-columns:repeat(2, 1fr);gap:16px;flex:1}.mock-stat{display:flex;flex-direction:column;gap:8px}.mock-stat-label{font-size:12px;color:rgba(255,255,255,0.6);text-transform:uppercase;letter-spacing:0.5px;font-weight:600}.mock-stat-value{font-size:24px;font-weight:700}.mock-stat-value.mock-correct{color:#66bb6a}.mock-stat-value.mock-wrong{color:#ff6b6b}.mock-stat-value.mock-unattempted{color:#ffa726}.mock-results-detail{margin-bottom:24px}.mock-results-detail h3{font-size:16px;font-weight:700;margin-bottom:16px}.mock-results-list{display:flex;flex-direction:column;gap:12px}.mock-result-item{padding:16px;background:rgba(255,255,255,0.05);border-left:4px solid rgba(255,255,255,0.1);border-radius:6px}.mock-result-item.correct{border-left-color:#66bb6a;background:rgba(102,187,106,0.1)}.mock-result-item.wrong{border-left-color:#ff6b6b;background:rgba(255,107,107,0.1)}.mock-result-q-text{font-size:14px;color:rgba(255,255,255,0.9);margin-bottom:8px;line-height:1.4}.mock-result-answers{display:flex;gap:12px;font-size:12px}.mock-result-your-ans{color:rgba(255,255,255,0.7)}.mock-result-correct-ans{color:#66bb6a;font-weight:600}.mock-results-actions{display:flex;gap:12px}.mock-btn-primary,.mock-btn-secondary{flex:1;padding:12px 24px;border:none;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer;transition:all 0.3s ease}.mock-btn-primary{background:linear-gradient(135deg, #6366f1 0%, #4f46e5 100%);color:#fff}.mock-btn-primary:hover{background:linear-gradient(135deg, #4f46e5 0%, #4338ca 100%)}.mock-btn-secondary{background:rgba(255,255,255,0.1);color:#fff;border:1px solid rgba(255,255,255,0.2)}.mock-btn-secondary:hover{background:rgba(255,255,255,0.15)}.mock-daily-limit-alert{position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.7);z-index:10001;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px)}.mock-limit-content{background:linear-gradient(135deg, #1a1a2e 0%, #16213e 100%);border-radius:16px;padding:32px;max-width:400px;width:100%;text-align:center;border:1px solid rgba(255,255,255,0.1)}.mock-limit-icon{font-size:48px;margin-bottom:16px}.mock-limit-content h2{font-size:22px;font-weight:700;margin-bottom:12px}.mock-limit-content p{color:rgba(255,255,255,0.7);font-size:14px;line-height:1.5;margin-bottom:8px}.mock-limit-premium{color:#ffa726;font-weight:600;margin-bottom:24px}.mock-limit-actions{display:flex;gap:12px}.mock-loading-overlay{position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.8);z-index:9998;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;color:#fff;backdrop-filter:blur(4px)}.mock-spinner{width:50px;height:50px;border:4px solid rgba(255,255,255,0.2);border-top-color:#6366f1;border-radius:50%;animation:mock-spin 1s linear infinite}@keyframes mock-spin{to{transform:rotate(360deg)}}.mock-error-alert{position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.7);z-index:10001;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(4px)}.mock-error-content{background:linear-gradient(135deg, #1a1a2e 0%, #16213e 100%);border-radius:16px;padding:32px;max-width:400px;width:100%;border:2px solid #ff6b6b}.mock-error-content h3{font-size:18px;font-weight:700;color:#ff6b6b;margin-bottom:12px}.mock-error-content p{color:rgba(255,255,255,0.7);font-size:14px;margin-bottom:20px;line-height:1.5}@media (max-width: 768px){.mock-results-score{flex-direction:column}.mock-results-stats{grid-template-columns:repeat(2, 1fr)}.mock-nav-section{flex-wrap:wrap}.mock-nav-btn{flex:0 1 calc(50% - 6px)}.mock-nav-btn.mock-nav-submit{flex-basis:100%;max-width:none}}`;
    document.head.appendChild(style);

    const html = `<div id="mockTestFullscreenModal" class="mock-fullscreen-modal" style="display:none;"><div class="mock-header"><div class="mock-header-left"><button class="mock-btn-back" onclick="MockTestInterfaceModule.closeTest()">← Back</button><div class="mock-exam-info"><div class="mock-exam-name" id="mockExamName">--</div><div class="mock-exam-progress"><span id="mockCurrentQ">0</span>/<span id="mockTotalQ">0</span> Questions</div></div></div><div class="mock-header-right"><div class="mock-timer" id="mockTimer">00:00</div><button class="mock-btn-close" onclick="MockTestInterfaceModule.closeTest()">✕</button></div></div><div class="mock-container"><div class="mock-question-section"><div class="mock-question-card"><div class="mock-question-number" id="mockQNumber">Question 1</div><div class="mock-question-text" id="mockQuestionText">Loading question...</div><div class="mock-options"><button class="mock-option" onclick="MockTestInterfaceModule.selectAnswer(0)" id="mockOpt0"><span class="mock-option-letter">A</span><span class="mock-option-text" id="mockOptText0">Option A</span></button><button class="mock-option" onclick="MockTestInterfaceModule.selectAnswer(1)" id="mockOpt1"><span class="mock-option-letter">B</span><span class="mock-option-text" id="mockOptText1">Option B</span></button><button class="mock-option" onclick="MockTestInterfaceModule.selectAnswer(2)" id="mockOpt2"><span class="mock-option-letter">C</span><span class="mock-option-text" id="mockOptText2">Option C</span></button><button class="mock-option" onclick="MockTestInterfaceModule.selectAnswer(3)" id="mockOpt3"><span class="mock-option-letter">D</span><span class="mock-option-text" id="mockOptText3">Option D</span></button></div></div></div><div class="mock-nav-section"><button class="mock-nav-btn" onclick="MockTestInterfaceModule.previousQuestion()" id="mockPrevBtn" disabled>← Previous</button><div class="mock-nav-counter" id="mockNavCounter"></div><button class="mock-nav-btn mock-nav-submit" onclick="MockTestInterfaceModule.submitTest()">Submit Test</button><button class="mock-nav-btn" onclick="MockTestInterfaceModule.nextQuestion()" id="mockNextBtn" disabled>Next →</button></div></div></div><div id="mockTestResultsModal" class="mock-results-modal" style="display:none;"><div class="mock-results-content"><button class="mock-btn-close" onclick="MockTestInterfaceModule.closeResults()" style="position:absolute;top:16px;right:16px;">✕</button><div class="mock-results-header"><h2 id="mockResultsTitle">Test Completed!</h2><p id="mockResultsSubtitle">Here's your performance</p></div><div class="mock-results-score"><div class="mock-score-circle"><div class="mock-score-accuracy" id="mockAccuracy">0%</div><div class="mock-score-label">Accuracy</div></div><div class="mock-results-stats"><div class="mock-stat"><span class="mock-stat-label">Correct</span><span class="mock-stat-value mock-correct" id="mockCorrectCount">0</span></div><div class="mock-stat"><span class="mock-stat-label">Wrong</span><span class="mock-stat-value mock-wrong" id="mockWrongCount">0</span></div><div class="mock-stat"><span class="mock-stat-label">Unattempted</span><span class="mock-stat-value mock-unattempted" id="mockUnAttemptedCount">0</span></div><div class="mock-stat"><span class="mock-stat-label">Time</span><span class="mock-stat-value" id="mockTimeTaken">0s</span></div></div></div><div class="mock-results-detail"><h3>Review Answers</h3><div id="mockResultsList" class="mock-results-list"></div></div><div class="mock-results-actions"><button class="mock-btn-primary" onclick="MockTestInterfaceModule.retakeMockTest()">Take Another Test</button><button class="mock-btn-secondary" onclick="MockTestInterfaceModule.closeResults()">Close</button></div></div></div><div id="mockDailyLimitAlert" class="mock-daily-limit-alert" style="display:none;"><div class="mock-limit-content"><div class="mock-limit-icon">🎯</div><h2>Daily Limit Reached</h2><p id="mockLimitMessage">You have used your 3 free mock tests for today.</p><p class="mock-limit-premium">Get <strong>Unlimited Mock Tests</strong> with Premium</p><div class="mock-limit-actions"><button class="mock-btn-primary" onclick="MockTestInterfaceModule.upgradePremium()">Upgrade</button><button class="mock-btn-secondary" onclick="MockTestInterfaceModule.closeDailyAlert()">Close</button></div></div></div><div id="mockLoadingOverlay" class="mock-loading-overlay" style="display:none;"><div class="mock-spinner"></div><p>Loading questions...</p></div><div id="mockErrorAlert" class="mock-error-alert" style="display:none;"><div class="mock-error-content"><h3>⚠ Error</h3><p id="mockErrorMessage">Unable to load questions from Firebase Storage</p><button class="mock-btn-secondary" onclick="MockTestInterfaceModule.closeError()">Close</button></div></div>`;
  ...
  const displayQuestion = () => {
    ...
    document.getElementById('mockQNumber').textContent = `Question ${q.index + 1}`;
  ...
  const selectAnswer = (idx) => { MockTestModule.submitAnswer(MockTestModule.getState().currentQuestionIndex, idx); displayQuestion(); };
  const nextQuestion = () => { if (MockTestModule.nextQuestion()) displayQuestion(); };
  const previousQuestion = () => { if (MockTestModule.previousQuestion()) displayQuestion(); };
  const submitTest = () => { finishTest(); };
  const finishTest = () => { testInProgress = false; clearInterval(window._mockTestTimer); const result = MockTestModule.finishMockTest(); if (!result.success) { showError(result.error); return; } document.getElementById('mockTestFullscreenModal').style.display = 'none'; displayResults(result.results); };
  ...
  const startTimer = () => { let elapsed = 0; const timerEl = document.getElementById('mockTimer'); window._mockTestTimer = setInterval(() => { elapsed++; const mins = Math.floor(elapsed / 60); const secs = elapsed % 60; timerEl.textContent = `${String(mins).padStart(2, '0')}:${String(secs).padStart(2, '0')}`; }, 1000); };
  const showDailyAlert = (dailyLimit) => { const alert = document.getElementById('mockDailyLimitAlert'); if (alert) { document.getElementById('mockLimitMessage').textContent = `You have used ${dailyLimit.used || 0} of ${dailyLimit.total} free tests today. Come back tomorrow or upgrade to Premium.`; alert.style.display = 'flex'; } };
  const showError = (message) => { const error = document.getElementById('mockErrorAlert'); if (error) { document.getElementById('mockErrorMessage').textContent = message; error.style.display = 'flex'; } };
  const retakeMockTest = () => { const examType = MockTestModule.getState().currentExam; closeResults(); MockTestModule.reset(); openTest(examType); };
  const closeTest = () => { clearInterval(window._mockTestTimer); MockTestModule.reset(); testInProgress = false; const modal = document.getElementById('mockTestFullscreenModal'); const results = document.getElementById('mockTestResultsModal'); if (modal) modal.style.display = 'none'; if (results) results.style.display = 'none'; };
  const closeResults = () => { const modal = document.getElementById('mockTestResultsModal'); if (modal) modal.style.display = 'none'; };
  const closeDailyAlert = () => { const alert = document.getElementById('mockDailyLimitAlert'); if (alert) alert.style.display = 'none'; };
  const closeError = () => { const error = document.getElementById('mockErrorAlert'); if (error) error.style.display = 'none'; };
  const upgradePremium = () => { closeDailyAlert(); if (typeof openPremiumModal === 'function') openPremiumModal(); };
