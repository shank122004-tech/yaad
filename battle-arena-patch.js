...
(function () {
  ...
  const POLL_BATTLE_LIST = 3000;            // ms — public battle list refresh
  ...
  */
  ...
  window.BA = {
    ...
    open() {
      injectStyles();
      createModals();
      // NEW: Force dark mode when opening battle arena
      this._originalTheme = document.documentElement.getAttribute('data-theme');
    ...
    close() {
      ...
      // NEW: Restore original theme ONLY when fully closing battle arena modal
    ...
    closeLb() {
      ...
      // NEW: Don't restore theme here - we're still in battle arena!
      // Only restore theme when fully closing battle arena with close()
    },
    ...
    async openLeaderboard() {
      ...
      // NEW: Keep dark mode for leaderboard (part of battle arena)
      document.documentElement.setAttribute('data-theme', 'dark');
      document.body.style.colorScheme = 'dark';
      this._lbTab = 'weekly';
