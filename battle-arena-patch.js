...
(function () {
  ...
  const POLL_ACTIVE_GAME = 2000;            // ms — PROFESSIONAL FIX v3.2.8: increased to 2000ms to prevent lag with 10 users
  ...
  */
  ...
  window.BA = {
    ...
    _renderActiveQuiz(battle) {
      ...
      if (!hashChanged && !questionChanged && timeSinceRender < 500 && document.getElementById('ba-qtimer-fill')) {
