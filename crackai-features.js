...
(function () {
  ...
  // ═══ CRITICAL FIX: Ensure Firebase is initialized ═══
  // Firebase SDK loads as ES6 module and may not be ready yet
  if (!window._firebaseAuth || !window._firebaseDb || !window._firebaseFns) {
    console.warn('[CrackAI] Waiting for Firebase initialization...');
